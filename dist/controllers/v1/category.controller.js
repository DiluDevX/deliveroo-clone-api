...
const getAllCategories = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const categoriesArray = yield category_service_1.categoryService.findAll(
        filters,
        req.query.populate
      );
      res.status(200).json({
...
const createNewCategory = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const foundRestaurant = yield restaurant_service_1.restaurantService.findOne(
        req.body.restaurant
      );
      if (!foundRestaurant) {
...
const updateCategoryFully = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const foundRestaurant = yield restaurant_service_1.restaurantService.findOne(
        req.body.restaurant
      ...
      const updatedCategory = yield category_service_1.categoryService.findByIdAndUpdate(
        req.params.id,
        req.body
      );
      if (!updatedCategory) {
...
const updateCategoryPartially = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      if (!req.body) {
      ...
      const patchedCategory = yield category_service_1.categoryService.findAndUpdatePartially(
        req.params.id,
        req.body
      );
      if (!patchedCategory) {
...
const deleteCategory = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const deletedCategory = yield category_service_1.categoryService.findByIdAndDelete(
        req.params.id
      );
      if (!deletedCategory) {
        res.status(404).json({ message: 'Category Not Found' });

...
exports.deleteARestaurant =
  exports.updateARestaurantFully =
  exports.updateARestaurantPartially =
  exports.getARestaurant =
  exports.createNewRestaurant =
...
const updateARestaurantFully = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const updatedRestaurant = yield restaurant_service_1.restaurantService.findByIdAndUpdate(
        req.params.id,
        req.body
      );
...
const updateARestaurantPartially = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const updatedRestaurant = yield restaurant_service_1.restaurantService.findAndUpdatePartially(
        req.params.id,
        req.body
      );
      if (!updatedRestaurant) {
...
const deleteARestaurant = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const deletedRestaurant = yield restaurant_service_1.restaurantService.findByIdAndDelete(
        req.params.id
      );

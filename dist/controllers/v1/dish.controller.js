...
exports.deleteDish =
  exports.updateDishFully =
  exports.updateDishPartially =
  exports.getADish =
  exports.createNewDish =
...
const updateDishFully = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const updatedDish = yield dish_service_1.dishService.findByIdAndUpdate(
        req.params.id,
        Object.assign(Object.assign({}, req.body), { restaurant: foundCategory.restaurant })
      );
      if (!updatedDish) {
        res.status(404).json({
          message: 'Dish Not Found',
...
const updateDishPartially = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      let foundCategory;
      ...
      const patchedDish = yield dish_service_1.dishService.findAndUpdatePartially(
        req.params.id,
        Object.assign(

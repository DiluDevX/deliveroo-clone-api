...
router.post('/', authorizeRole('admin'), ValidateBody(CreateDishRequestBodySchema), createNewDish);
...
router.delete('/:id', authorizeRole('admin'), ValidateParams(objectIdPathParamsSchema), deleteDish);
